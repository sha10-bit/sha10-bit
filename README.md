...
|---|---|---|
| [**Parallel & Distributed Processing**](https://github.com/sha10-bit/Efficient-Data-Processing-Using-Parallel-and-Distributed-Processing-) | High-throughput data pipeline using PDP on NYC Taxi Dataset — benchmarked parallel vs sequential performance | `Python` `PDP` `Big Data` |
| [**RHEL/CentOS Linux Admin**](https://github.com/sha10-bit/RHEL-CentOS-Linux-Administration) | Enterprise-grade Linux admin: LVM storage, auto jobs, local repos, env management, RPM packaging | `RHEL` `LVM` `Bash` |
| [**Linux Database Management**](https://github.com/sha10-bit/Linux-Database-Management) | Multi-DB Linux setup with MySQL, MSSQL & Oracle — complex JOINs, stored procedures, cross-DB queries | `MySQL` `Oracle` `SQL` |
| [**Supervised ML Pipeline**](https://github.com/sha10-bit/-Task-1--Prediction-using-only-Supervised-ML) | End-to-end ML pipeline: preprocessing → feature engineering → model selection → evaluation | `Python` `Scikit-learn` `Jupyter` |
| [**IT Infrastructure Labs**](https://github.com/sha10-bit/it-infrastructure-learning-labs) | Hands-on infrastructure labs across networking, server config, and enterprise systems | `Networking` `IT Infra` |
...
<img height="180em" src="https://github-readme-stats.vercel.app/api?username=sha10-bit&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true&border_radius=12"/>
&nbsp;
<img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=sha10-bit&layout=compact&langs_count=6&theme=tokyonight&border_radius=12"/>
...
```bash
$ sudo apt-get install next-level-skills

> Installing: Advanced Cloud Security & Zero Trust Architecture  ✅
> Installing: DevSecOps + CI/CD Pipeline Hardening               ✅
